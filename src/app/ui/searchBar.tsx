  ...
  return (
    <div>
      <div className="relative flex flex-1 flex-shrink-0 max-sm:hidden">
        ...
        <input
          className="peer block w-full dark:bg-zinc-950 rounded-md py-2 pl-10 text-sm 
      ...
      <div className="hidden p-3 bg-zinc-950 rounded-full border border-zinc-600 max-sm:block"><FaSearch /></div>
    </div>
  )
}
